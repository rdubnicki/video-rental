package pl.rdubnicki.videorental.manager;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.boot.context.event.ApplicationReadyEvent;
import org.springframework.context.event.EventListener;
import org.springframework.stereotype.Service;
import pl.rdubnicki.videorental.dao.VideoCassetteRepo;
...
public class VideoCassetteManager {
    ...
    public void fillDB() {
        save(new VideoCassette(1L, "Titanic", LocalDate.of(1997, 12, 12)));
        save(new VideoCassette(2L, "Pulp Fiction", LocalDate.of(1994, 05, 25)));
        save(new VideoCassette(3L, "Guns of Navarone", LocalDate.of(1961, 04, 27)));
    }
}
